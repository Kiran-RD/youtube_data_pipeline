...
## @type: DataSource
## @args: [database = "db-youtube-raw", table_name = "raw_stats", transformation_ctx = "datasource0"]
## @return: datasource0
## @inputs: []
...
datasource0 = glueContext.create_dynamic_frame.from_catalog(database = "db-youtube-raw", table_name = "raw_stats", transformation_ctx = "datasource0", push_down_predicate = predicate_pushdown)
## @type: ApplyMapping
...
## @type: DataSink
## @args: [connection_type = "s3", connection_options = {"path": "s3://bigdata-on-youtube-cleansed-apsouth1-krd-dev/youtube/raw-stats"}, format = "parquet", transformation_ctx = "datasink4"]
## @return: datasink4
...
datasink4 = glueContext.write_dynamic_frame.from_options(frame = df_final_output, connection_type = "s3", connection_options = {"path": "s3://bigdata-on-youtube-cleansed-apsouth1-krd-dev/youtube/raw-stats", "partitionkeys":["region"]}, format = "parquet", transformation_ctx = "datasink4")
#######################Added by Kiran##################################
job.commit()